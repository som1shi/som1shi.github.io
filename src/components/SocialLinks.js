...
const SocialLinks = () => {
    return (
        <div className="social-links">
            <button
                type="button"
                className="social-button os32-button"
                onClick={() => window.open('https://os32.vercel.app', '_blank')}
                aria-label="Open os32 project"
            >
                Try os32
            </button>
            <a 
                href="https://www.linkedin.com/in/sarvagyasomvanshi/" 
                target="_blank" 
